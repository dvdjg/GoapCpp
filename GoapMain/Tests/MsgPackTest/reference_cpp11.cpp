...
TEST(reference_cpp11, unpack_int)
{
...
TEST(reference_cpp11, unpack_string)
{
    msgpack::sbuffer sbuf;
...
TEST(reference_cpp11, unpack_bin)
{
    msgpack::sbuffer sbuf;
...
TEST(reference_cpp11, unpack_ext)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> packer(sbuf);
    char const buf [] = { 2 };
...
static bool never_called(msgpack::type::object_type, std::size_t, void*)
{
    EXPECT_TRUE(false);
    return false;
}

static bool always_reference(msgpack::type::object_type, std::size_t, void*)
{
    return true;
}

TEST(reference_cpp11, unpack_int_ref)
{
    msgpack::sbuffer sbuf;
    msgpack::pack(sbuf, 1);
    bool referenced;
...
TEST(reference_cpp11, unpack_string_ref)
{
    msgpack::sbuffer sbuf;
    msgpack::pack(sbuf, std::string("abcdefg"));
    bool referenced;
...
TEST(reference_cpp11, unpack_bin_ref)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> packer(sbuf);
    char c[] = { 1, 2, 3, 4, 5, 6 };
...
TEST(reference_cpp11, unpack_ext_ref)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> packer(sbuf);
    char const buf [] = { 2 };
...
static bool sized_reference(msgpack::type::object_type t, std::size_t s, void* p)
{
    s_p = p;
    switch (t) {
...
TEST(reference_cpp11, unpack_int_sized_ref)
{
    msgpack::sbuffer sbuf;
    msgpack::pack(sbuf, 1);
...
TEST(reference_cpp11, unpack_string_sized_ref_4)
{
    msgpack::sbuffer sbuf;
...
TEST(reference_cpp11, unpack_string_sized_ref_5)
{
    msgpack::sbuffer sbuf;
...
TEST(reference_cpp11, unpack_bin_sized_ref_5)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> packer(sbuf);
    char c[] = { 1, 2, 3, 4, 5 };
...
TEST(reference_cpp11, unpack_bin_sized_ref_6)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> packer(sbuf);
    char c[] = { 1, 2, 3, 4, 5, 6 };
...
TEST(reference_cpp11, unpack_ext_sized_ref_6)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> packer(sbuf);
...
TEST(reference_cpp11, unpack_ext_sized_ref_7)
{
    msgpack::sbuffer sbuf;
    msgpack::packer<msgpack::sbuffer> packer(sbuf);
