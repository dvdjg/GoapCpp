...
class SQLiteEncrypted : public ::testing::Test
{

public:
    sqlite3 *db = nullptr;
    static const char *key;
    static const char *dbname; // In the connection directory
    int keylen = 7;
...
const char *SQLiteEncrypted::dbname = "./testdb"; // In the connection directory
const char *SQLiteEncrypted::key = "anotherkey";

TEST_F(SQLiteEncrypted, createDB)
{
    char *error = 0;
    int rc = 0;
...
TEST_F(SQLiteEncrypted, selectDB)
{
    char *error = 0;
    int rc = 0;
