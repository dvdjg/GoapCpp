...
public:
    ...
    IStringValue* fromString(const std::string &str) override;
    IStringValue* assign(const StateValue &other);
    IStringValue* assign(const IStateValue::CPtr &other) override;
    IStringValue* assign(const std::string &other) override;
    IStringValue* assign(const char* other) override;
    IStringValue* assign(const std::initializer_list<float> &list) override;
